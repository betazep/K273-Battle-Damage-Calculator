Z rozkazu krále Pchelovoda platí pro království následující ROE.
...
5. Platí nulová tolerance vůči rasistickému, nenávistnému, ponižujícímu nebo výhružnému jazyku.
6. Porušení lze hlásit Králi/Královně nebo Králově Ruce.
7. Může být přidělen negativní titul a/nebo status psance.
8. Hrozby jsou brány velmi vážně, stejně jako šikana, protože jsou v rozporu s pravidly Kodexu chování TOTAL BATTLE. Královský chat je místo, kde by se všichni měli cítit vítáni.

## Královští úředníci - Palác

- Palác je zodpovědný za udržování cti, integrity a míru v K273 a s ostatními královstvími.
- Král je volen, aby zastupoval občany K273 a předsedal paláci.
- Královna a Králova Ruka jsou odpovědné za koordinaci záležitostí království a mohou mluvit jménem Krále v jeho nepřítomnosti.
- Král, Královna a Králova Ruka jsou odpovědní za správu pokladny jménem hráčů království.
...
- Vzdělávat své členy, aby podporovali růst a jednotu království.
...
Nechránění hráči jsou:
- PSANCI
- HRÁČI BEZ KLANU (nad 100k)
- NE-ROE ČLENOVÉ

Chránění hráči bez klanu

Všichni hráči s 100k síly nebo méně jsou chráněni a neměli by být volně napadáni.
...
- Pokud mezi klanovými diplomaty není dosaženo řešení, mohou případ předložit soudu tím, že jej zveřejní v #K273/CLAIMS. Pouze klanoví vůdci nebo diplomaté mohou v tomto chatu zveřejňovat nároky.
