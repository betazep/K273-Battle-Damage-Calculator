...
en: {
            strings: {
                ...
                "library.search.label": "Search subjects",
                "library.search.placeholder": "Search by subject or theme",
                "library.search.empty": "No subjects match your search.",
                "library.count.subjects": "subjects",
...
`
            ...
            strings: {
                ...
                "library.search.label": "Hae aiheita",
                "library.search.placeholder": "Hae aiheen tai teeman mukaan",
                "library.search.empty": "Hakua vastaavia aiheita ei löytynyt.",
                "library.count.subjects": "aiheet",
...
no: {
            strings: {
                ...
                "library.search.label": "Søk etter emner",
                "library.search.placeholder": "Søk etter emne eller tema",
                "library.search.empty": "Ingen emner matcher søket ditt.",
                "library.count.subjects": "emner",
...
de: {
            strings: {
                ...
                "library.search.label": "Themen suchen",
                "library.search.placeholder": "Nach Thema oder Themenbereich suchen",
                "library.search.empty": "Keine Themen passen zu deiner Suche.",
                "library.count.subjects": "Themen",
...
es: {
            strings: {
                ...
                "library.search.label": "Buscar temas",
                "library.search.placeholder": "Buscar por tema o categoría",
                "library.search.empty": "No hay temas que coincidan con tu búsqueda.",
                "library.count.subjects": "temas",
...
fr: {
            strings: {
                ...
                "library.search.label": "Rechercher des sujets",
                "library.search.placeholder": "Rechercher par sujet ou thème",
                "library.search.empty": "Aucun sujet ne correspond à votre recherche.",
                "library.count.subjects": "sujets",
...
it: {
            strings: {
                ...
                "library.hero.eyebrow": "K273 | Biblioteca",
                "library.title": "Biblioteca K273",
                "library.search.label": "Cerca argomenti",
                "library.search.placeholder": "Cerca per argomento o tema",
                "library.search.empty": "Nessun argomento corrisponde alla tua ricerca.",
                "library.count.subjects": "argomenti",
...
pt: {
            strings: {
                ...
                "library.hero.eyebrow": "K273 | Biblioteca",
                "library.title": "Biblioteca K273",
                "library.search.label": "Buscar assuntos",
                "library.search.placeholder": "Buscar por assunto ou tema",
                "library.search.empty": "Nenhum assunto corresponde à sua pesquisa.",
                "library.count.subjects": "assuntos",
...
pl: {
            strings: {
                ...
                "library.search.label": "Szukaj tematów",
                "library.search.placeholder": "Szukaj po temacie lub motywie",
                "library.search.empty": "Brak tematów pasujących do wyszukiwania.",
                "library.count.subjects": "tematów",
...
ru: {
            strings: {
                ...
                "library.search.label": "Поиск тем",
                "library.search.placeholder": "Поиск по теме или разделу",
                "library.search.empty": "По вашему запросу темы не найдены.",
                "library.count.subjects": "тем",
...
sv: {
            strings: {
                ...
                "library.hero.eyebrow": "K273 | Bibliotek",
                "library.title": "K273 Bibliotek",
                "library.search.label": "Sök ämnen",
                "library.search.placeholder": "Sök efter ämne eller tema",
                "library.search.empty": "Inga ämnen matchar din sökning.",
                "library.count.subjects": "ämnen",
