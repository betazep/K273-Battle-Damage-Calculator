...
`
            ...
            strings: {
                ...
                "library.section.sub": "K273:n kivien sisällä Tietokirjasto vartioi muinaisia tomuja, joihin on kaiverrettu taistelutaidon, kunnian ja jokaisen piirityksen muisto. Jokaisen sivun sanotaan kuiskaavan oppinsa niille, jotka etsivät valtakunnan viisautta.",
...
no: {
            strings: {
                ...
                "library.section.sub": "Innenfor K273s murer vokter Kunnskapsbiblioteket eldgamle tomer, risset med krigskunst, ære og minnet om hver beleiring. Hver side sies å hviske sine læresetninger til dem som søker rikets visdom.",
...
de: {
            strings: {
                ...
                "library.section.sub": "Innerhalb der Mauern von K273 bewacht die Bibliothek des Wissens uralte Folianten, gezeichnet von Kriegskunst, Ehre und der Erinnerung an jede Belagerung. Man sagt, jede Seite flüstere ihre Lehren denen zu, die die Weisheit des Königreichs suchen.",
...
es: {
            strings: {
                ...
                "library.section.sub": "Dentro de las piedras de K273, la Biblioteca del Conocimiento custodia tomos ancestrales grabados con arte de guerra, honor y la memoria de cada asedio. Se dice que cada página susurra sus lecciones a quienes buscan la sabiduría del reino.",
...
fr: {
            strings: {
                ...
                "library.section.sub": "Au cœur des pierres de K273, la Bibliothèque du savoir garde des tomes anciens gravés de l'art de la guerre, de l'honneur et du souvenir de chaque siège. On dit que chaque page murmure ses leçons à ceux qui cherchent la sagesse du royaume.",
...
it: {
            strings: {
                ...
                "library.section.sub": "Tra le pietre di K273, la Biblioteca del sapere custodisce tomi antichi incisi con arte della guerra, onore e memoria di ogni assedio. Si dice che ogni pagina sussurri i suoi insegnamenti a chi cerca la saggezza del regno.",
...
pt: {
            strings: {
                ...
                "library.section.sub": "Nas pedras de K273, a Biblioteca do conhecimento guarda tomos antigos gravados com arte da guerra, honra e a memória de cada cerco. Diz-se que cada página sussurra suas lições àqueles que buscam a sabedoria do reino.",
...
pl: {
            strings: {
                ...
                "library.section.sub": "W murach K273 Biblioteka wiedzy strzeże pradawnych tomów zapisanych sztuką wojny, honorem i pamięcią każdej oblężonej bitwy. Mówi się, że każda strona szepcze swoje nauki tym, którzy szukają mądrości królestwa.",
...
ru: {
            strings: {
                ...
                "library.section.sub": "В каменных стенах K273 Библиотека знаний хранит древние тома, в которых запечатлены искусство войны, честь и память о каждой осаде. Говорят, что каждая страница шепчет свои уроки тем, кто ищет мудрость королевства.",
...
sv: {
            strings: {
                ...
                "library.section.sub": "Innanför K273s murar vaktar Kunskapsbiblioteket uråldriga tomer, ristade med krigskonst, heder och minnet av varje belägring. Det sägs att varje sida viskar sina lärdomar till dem som söker rikets visdom.",
