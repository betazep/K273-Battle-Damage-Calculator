    ...
    const translations = {
        en: {
            strings: {
                ...
                "palace.roe.subtitle": "Kingdom guidelines for combat and conduct.<br>English version is the official ROE (Translations via AI)<br>Last Updated 12/20/2025",
...
`
            ...
            strings: {
                ...
                "palace.roe.subtitle": "Kuningaskunnan ohjeet taisteluun ja käytökseen.<br>Englanninkielinen versio on virallinen ROE (Käännökset AI:n avulla)<br>Päivitetty 12/20/2025",
...
`
        ...
        no: {
            strings: {
                ...
                "palace.roe.subtitle": "Kongedømmets retningslinjer for kamp og opptreden.<br>Den engelske versjonen er den offisielle ROE (Oversettelser via AI)<br>Sist oppdatert 12/20/2025",
...
`
        ...
        de: {
            strings: {
                ...
                "palace.roe.subtitle": "Richtlinien des Königreichs für Kampf und Verhalten.<br>Die englische Version ist das offizielle ROE (Übersetzungen via KI)<br>Zuletzt aktualisiert 12/20/2025",
...
`
        ...
        es: {
            strings: {
                ...
                "palace.roe.subtitle": "Directrices del reino para el combate y la conducta.<br>La versión en inglés es el ROE oficial (Traducciones vía IA)<br>Última actualización 12/20/2025",
...
`
        ...
        fr: {
            strings: {
                ...
                "palace.roe.subtitle": "Directives du royaume pour le combat et la conduite.<br>La version anglaise est le ROE officiel (Traductions via IA)<br>Dernière mise à jour 12/20/2025",
...
`
        ...
        pt: {
            strings: {
                ...
                "palace.roe.subtitle": "Diretrizes do reino para combate e conduta.<br>A versão em inglês é o ROE oficial (Traduções via IA)<br>Última atualização 12/20/2025",
...
`
        ...
        pl: {
            strings: {
                ...
                "palace.roe.subtitle": "Wytyczne królestwa dotyczące walki i zachowania.<br>Wersja angielska jest oficjalnym ROE (Tłumaczenia przez AI)<br>Ostatnia aktualizacja 12/20/2025",
...
`
        ...
        ru: {
            strings: {
                ...
                "palace.roe.subtitle": "Руководство королевства по бою и поведению.<br>Английская версия — официальная ROE (Переводы через ИИ)<br>Последнее обновление 12/20/2025",
...
`
        ...
        sv: {
            strings: {
                ...
                "palace.roe.subtitle": "Rikets riktlinjer för strid och uppförande.<br>Engelska versionen är officiell ROE (Översättningar via AI)<br>Senast uppdaterad 12/20/2025",
