...
`
            ...
            strings: {
                ...
                "library.section.sub": "TULOSSA PIAN",
...
no: {
            strings: {
                ...
                "library.section.sub": "KOMMER SNART",
...
de: {
            strings: {
                ...
                "library.section.sub": "BALD VERFÜGBAR",
...
es: {
            strings: {
                ...
                "library.section.sub": "PRÓXIMAMENTE",
...
it: {
            strings: {
                ...
                "library.section.sub": "PROSSIMAMENTE",
...
pl: {
            strings: {
                ...
                "library.count.subjects": "książek",
